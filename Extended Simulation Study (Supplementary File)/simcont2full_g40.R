...
cont.ranges<-weight_avg(bwidth = 0.40)
...
save.image("conti2rsim1_010_090g_lamda_040.RData")
...
quilt.plot(grid,sqrt(cont.ranges),nx=N,ny=N,col = viridis(n=5000),horizontal=T,zlim=c(0.1,0.9),xlab="x",ylab="y",
           axis.args = list(at = seq(from = 0.1,to=0.9,length.out = 5), labels=seq(from = 0.1,to=0.9,length.out = 5))) #### 453 by 487 saving resolution
