...
cont.ranges<-weight_avg(bwidth = 0.30)
...
save.image("conti2rsim1_010_090g_lamda_030.RData")
...
quilt.plot(grid,sqrt(cont.ranges),nx=N,ny=N,col = viridis(n=5000),horizontal=T,zlim=round(range(sqrt(cont.ranges)),2),xlab="x",ylab="y",
